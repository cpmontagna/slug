...
path_data = '../data/Somigliana/';
% filenames
dispFileName = 'disp';
strainFileName = 'strain';

%% parameters:
% rock parameters for Somigliana model
alfa = 3000; % S-wave propagation speed [m/s]
beta = 1700; % P-wave propagation speed [m/s]
rho = 2500; % rock density [kg/m3]
...
Green = 'false';   % 'false' uses Somigliana tensor approximation
% ========================================================================
